          ...
          {event && (
            <>
              ...
              <p className="text-lg font-medium text-neutral-600 dark:text-neutral-200">
                <strong>Fecha:</strong> { event?.date && new Date(event?.date).toLocaleString('es-MX', { month: 'long', day: 'numeric' }) }
              </p>
              <p className="text-lg font-medium text-neutral-600 dark:text-neutral-200">
              ...
              {isAdmin && (
                <>
                  <p className="mt-6">
                    <Button color="red" onClick={handleOnDeleteEvent}>Eliminar Reporte</Button>
                  </p>
                </>
              )}
            </>
